...
var dateObject = new Date(); //instantiating an object type DATE, it is using the object´s
//standard constructor, which gets the sysdate and load into the object (dateObject).
var countdown; //global variable for the countdown.
//the ticket below is a class/object. The object was declared directly and JavaScript
//already creates the class and constructors to it, with the fields/atributes.
var ticket = { 
...
function displayCalendar(whichMonth) {
   ...
   var monthArray = ["January","February","March","April","May",
      "June","July","August","September","October","November",
       "December"];
    //if below gets current month and show 1 month earlier and 1 month later than current month.
   if (whichMonth === -1) {
   ...
   dateObject.setDate(1);
    ...
    //display title that contains month name and year on the calendar
...
function selectDate(event) {
   ...
   if (callerElement.innerHTML === "") {
    ...
    //date selected is in the past, calendar stays displayed.
